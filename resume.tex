...
\addtofrontsidebar{
    ...
    \profilesection{编程能力}
        \pointskill{\faCompress}{Python}{5}
		\pointskill{\faCompress}{Django}{5}
		\pointskill{\faCompress}{SQLite}{5}
        \pointskill{\faCompress}{SQLAlchemy}{5}
		\pointskill{\faCompress}{Java}{5}
		\pointskill{\faCompress}{Flask}{4}
		\pointskill{\faCompress}{Spark}{5}
        \pointskill{\faCompress}{Maven}{4}
		\pointskill{\faCompress}{MongoDB}{4}
		\pointskill{\faCompress}{Linux}{5}
		\pointskill{\faCompress}{Docker}{5}

    \profilesection{获奖情况}
        \cvitem{2017}{校级奖学金二等奖}{}{}
        \cvitem{2017}{校级优秀学生}{}{}
        \cvitem{2018}{本科校级优秀毕业生}{}{}
        \cvitem{2018}{校级奖学金三等奖}{}{}
        \cvitem{2019}{校级优秀学生}{}{}
...
\cvsection{教育背景}
    ...
    \subsection{研究生经历}
    \begin{cvtable}
        \cvitem{2018 -- 2021}{上海海事大学}{GPA:前10$\%$}
    ...
    \subsection{本科经历}
    \begin{cvtable}
        \cvitem{2014 -- 2018}{辽宁工程技术大学}{GPA:前5$\%$}
...
\cvsection{所持证书}
    \begin{cvtable}
        ...
        \cvitem{2019年}{IEEE生物特征冬令营优秀学员}{}{}
        \cvitem{2019年}{人工智能开发者大会挑战赛一等奖}{}{}
    \end{cvtable}
